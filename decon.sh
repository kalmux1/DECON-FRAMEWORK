...
then
    ...
    choice()
    {
        echo " "
        echo " "
        echo -e "                        $BIRed  [1]$Normal $(tput setaf 5) WHOIS $(tput sgr0)"
        echo -e "                        $BIRed  [2]$Normal $(tput setaf 5) WHATWEB $(tput sgr0)"
        echo -e "                        $BIRed  [3]$Normal $(tput setaf 5) DNSENUM $(tput sgr0)"
        echo -e "                        $BIRed  [3]$Normal $(tput setaf 5) NMAP $(tput sgr0)"
        echo " "
        echo " "
        echo " "
